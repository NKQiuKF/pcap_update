...
from collecting import server_call
import optparse
import os
import platform
import subprocess
...
from core.update import load_trails
...
def main():
    ...
    try:
        ...
        if config.UDP_ADDRESS and config.UDP_PORT:
            ...
            #print(1)
            start_logd(address=config.UDP_ADDRESS, port=config.UDP_PORT, join=False, maltrails = trails)
        #print(2)
