...
pointsuperset = os.path.dirname(os.path.abspath(__file__))+'/.superset'
SQLALCHEMY_DATABASE_URI = 'sqlite:///' + os.path.join(pointsuperset, 'superset.db')
...
APP_ICON = '/static/assets/images/pcaplog.png'
