...
(function(window) {
    ...
    */
    ...
    var settings = {
        ...
        // Websocket settings
        wsHost: "ws://127.0.0.1:8000/",//HOST_IP
            ...
            new Stats({
                ...
                redraw: function() {
                    ...
                    var rows = d3.select("#events-data").selectAll("tr.row")
                        .data(this.state, function(d) { console.log('mmmmmmmmmmmm'); console.log(d); return d.id; });
    ...
    queue()
        .defer(d3.json, "../../static/data/readme-world.json")
        .defer(d3.tsv, "../../static/data/port-names.tsv")
        .defer(d3.csv, "../../static/data/country-codes.csv")
